...
function ribosome_setup() {
	 ...
	 */
	add_editor_style( array( 'css/editor-style.css', ribosome_get_font_url() ) );
	...
	$theme_color = get_theme_mod( 'ribosome_theme_color', '#00BCD5' );

	add_theme_support( 'editor-color-palette', array(
		array(
			'name'  => __( 'Theme color', 'ribosome' ),
			'slug'  => 'theme-color',
			'color' => $theme_color,
		),
		array(
			'name'  => __( 'Dark gray', 'ribosome' ),
			'slug'  => 'dark-gray',
			'color' => '#333',
		),
		array(
			'name'  => __( 'Medium gray', 'ribosome' ),
			'slug'  => 'medium-gray',
			'color' => '#999',
		),
		array(
			'name'  => __( 'Light gray', 'ribosome' ),
			'slug'  => 'light-gray',
			'color' => '#f2f2f2',
		),
		array(
			'name'  => __( 'White', 'ribosome' ),
			'slug'  => 'white',
			'color' => '#fff',
		),
	) );
	...
	add_theme_support( 'editor-font-sizes', array(
		array(
			'name'      => __( 'Small', 'ribosome' ),
			'shortName' => __( 'S', 'ribosome' ),
			'size'      => 12,
			'slug'      => 'small',
		),
		array(
			'name'      => __( 'Normal', 'ribosome' ),
			'shortName' => __( 'M', 'ribosome' ),
			'size'      => 16,
			'slug'      => 'normal',
		),
		array(
			'name'      => __( 'Large', 'ribosome' ),
			'shortName' => __( 'L', 'ribosome' ),
			'size'      => 20,
			'slug'      => 'large',
		),
		array(
			'name'      => __( 'Huge', 'ribosome' ),
			'shortName' => __( 'XL', 'ribosome' ),
			'size'      => 24,
			'slug'      => 'huge',
		),
	) );
...
function ribosome_scripts_styles() {
	...
	wp_enqueue_style( 'ribosome-block-style', get_template_directory_uri() . '/css/blocks.css', '', RIBOSOME_VERSION );
 ...
 */
function ribosome_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'ribosome-block-editor-style', get_template_directory_uri() . '/css/editor-blocks.css' );
	// Add custom fonts.
	wp_enqueue_style( 'ribosome-block-editor-fonts', ribosome_get_font_url(), array(), null );
}
add_action( 'enqueue_block_editor_assets', 'ribosome_block_editor_styles' );
